...
public class Input {
    ...
    private List<LastScore> lastScores = new ArrayList<LastScore>();
    @JsonIgnore
    ...
    @JsonProperty("lastScores")
    public List<LastScore> getLastScores() {
        return lastScores;
    }

    @JsonProperty("lastScores")
    public void setLastScores(List<LastScore> lastScores) {
        this.lastScores = lastScores;
    }

    public Input withLastScores(List<LastScore> lastScores) {
        this.lastScores = lastScores;
        return this;
    }
